...
%			\tableofcontents
			...
			\textbf{6. Maths : }
			\newline
			6.1 -  Chinese Remainder Theorem, \quad6.2 - Discrete Log, \quad6.3 - NTT, \quad6.4 - Online FFT , \quad6.5 - Langrange Interpolation, \quad6.6 - Matrix Struct, \quad6.7 - nCr(Non Prime Modulo), \quad6.8 - Primitive Root Generator, \quad6.9 - Math Miscellaneous, \quad6.10 -  Group Theory
	...
	\par\vskip 3pt
	\subsubsection*{Ideas}
	Div and Conq, Brute force and observe, (+1,-1), Dominator Tree for Directed Graph, use fenwick, Monte Carlo, Summation Interchange, Clever Optimization of brute force(binary search/ignore), Try solving problem backwards, ***Analysis Complexity Carefully, Relate To Theory***, First Find Solution for small sub-problems
